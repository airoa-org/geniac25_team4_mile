...
from mile.models.common import Decoder, LanguageEncoder
from mile.layers.layers import BasicBlock
from mile.models.transition import RSSM
from mile.models.tdmpc2_utils.layers import conv, SimNorm, mlp
...
class RobotMile_TDMPC2(nn.Module):
    def __init__(self, cfg):
        ...
        # Joint state encoder
        self.joint_encoder = mlp(cfg.obs_shape['state'][0] + cfg.task_dim, max(cfg.num_enc_layers-1, 1)*[cfg.enc_dim], cfg.MODEL.JOINT.HIDDEN_DIM, act=SimNorm(cfg))
        ...
        # TODO: replace with TD-MPC2 transition model
